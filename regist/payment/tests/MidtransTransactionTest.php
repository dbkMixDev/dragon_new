...
class MidtransTransactionTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testStatus()
    {
        ...
        $this->assertEquals(
            "https://api.midtrans.com/v2/Order-111/status",
    ...
    public function testApprove()
    {
        ...
        $this->assertEquals(
            "https://api.midtrans.com/v2/Order-111/approve",
            MT_Tests::$lastHttpRequest["url"]
        );
    ...
    public function testCancel()
    {
        ...
        $this->assertEquals(
            "https://api.midtrans.com/v2/Order-111/cancel",
            MT_Tests::$lastHttpRequest["url"]
        );
    ...
    public function testExpire()
    {
        ...
        $this->assertEquals(
            "https://api.midtrans.com/v2/Order-111/expire",
            MT_Tests::$lastHttpRequest["url"]
        );
    ...
    public function testRefund()
    {
        ...
        $this->assertEquals(
            "https://api.midtrans.com/v2/Order-111/refund",
            MT_Tests::$lastHttpRequest["url"]
        );
    ...
    public function testRefundDirect()
    {
        ...
        $this->assertEquals(
            "https://api.midtrans.com/v2/Order-111/refund/online/direct",
            MT_Tests::$lastHttpRequest["url"]
        );
        $fields = MT_Tests::lastReqOptions();
        $this->assertEquals(1, $fields["POST"]);
    ...
    public function testDeny()
    {
        ...
        $this->assertEquals(
            "https://api.midtrans.com/v2/Order-111/deny",
            MT_Tests::$lastHttpRequest["url"]
        );
